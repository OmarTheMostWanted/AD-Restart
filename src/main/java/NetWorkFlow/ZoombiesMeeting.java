...
public class ZoombiesMeeting {
   ...
   static class MaxFlow {
     ...
     * @param connections set of connections between nodes labelled 1 <= label <= n
     * @return the maximum number of _round_trips that can be done.
     */
    int zombieFreeRuns(int n, int startNodeId, int endNodeId, Set<Connection> connections) {
        ...
        Graph g = new Graph(ns , s , t);
        var oneway = MaxFlow.maximizeFlow(g);
        return oneway/2;
    }
}
